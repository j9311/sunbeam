  ...
  return (
    <div className="mx-auto w-3/4 flex flex-col align-center text-center">
      ...
      <p>
        ...
        SITE AND YOUR RELIANCE OF ANY INFORMATION ON THE SITE IS SOLELY AT YOUR
        OWN RISK
      </p>
      <br />
      ...
      <p>
        ...
        you, whether personally or on behalf of an entity (“you”) and NFToast
        ("Company", “we”, “us”, or “our”), concerning your access to and use of
        the NFToast website as well as any other media form, media channel,
        ...
        MUST DISCONTINUE USE IMMEDIATELY. Supplemental terms and conditions or
        ...
        not tailored to comply with industry-specific regulations (Health
      ...
      <p>
        ...
        contained therein. 4. Use any information obtained from the Site in
        order to harass, abuse, or harm another person. 5. Make improper use of
        our support services or submit false reports of abuse or misconduct. 6.
        Use the Site in a manner inconsistent with any applicable laws or
        regulations. 7. Use the Site to advertise or offer to sell goods and
        services. 8. Engage in unauthorized framing of or linking to the Site.
        ...
        features, functions, operation, or maintenance of the Site. 10. Engage
        ...
        proprietary rights notice from any Content. 12. Attempt to impersonate
        another user or person or use the username of another user. 13. Upload
        ...
        or “pcms”). 14. Interfere with, disrupt, or create an undue burden on
        the Site or the networks or services connected to the Site. 15. Harass,
        annoy, intimidate, or threaten any of our employees or agents engaged in
        providing any portion of the Site to you. 16. Attempt to bypass any
        measures of the Site designed to prevent or restrict access to the Site,
        or any portion of the Site. 17. Copy or adapt the Site’s software,
        including but not limited to Flash, PHP, HTML, JavaScript, or other
        code. 18. Decipher, decompile, disassemble, or reverse engineer any of
        the software comprising or in any way making up a part of the Site. 19.
        ...
        unauthorized script or other software. 20. Make any unauthorized use of
        the Site, including collecting usernames and/or email addresses of users
        ...
        pretenses. 21. Use the Site as part of any effort to compete with us or
      ...
      <p>
        ...
        Suffolk County, Massachusetts, and the Parties hereby consent to, and
      ...
      <p>
        ...
        the parties hereto to execute these Terms of Use. NFToast does not
        guarantee data on the website is accurate, and content does not
        constitute as financial advise. Buy digital collectables at your own
        risk and use external resources to make decisions related to these
        purchases.
      </p>
      <br />
      <h1>CONTACT US</h1>
      <p>
        ...
        information regarding use of the Site, please contact us at: NFToast 110
        16th Ave Seattle, WA 98122 United States Phone: __________
        admin@nftoast.com.com These terms of use were created using Termly’s
        Terms and Conditions Generator. PRIVACY POLICY We care about data
        privacy and security. By using the Site, you agree to be bound by our
        Privacy Policy posted on the Site, which is incorporated into these
      ...
      <p>
        In order to resolve a complaint regarding the Site or to receive further
        information regarding use of the Site, please contact us at: NFToast 110
        16th Ave Seattle, WA 98122 United States Phone:(650) 265-1193
        admin@nftoast.com.com
      </p>
      <br />
      <h1>Privacy Policy </h1>
      <p>
        ...
        NFToast, 10 Glassworks Ave, Cambridge, MA 02141. Cookies are small files
        ...
        among its many uses. Country refers to: Massachusetts, United States
        ...
        page visit). Website refers to NFToast, accessible from NFToast You
        ...
        address Usage Data Usage Data Usage Data is collected automatically when
        ...
        allows You to create an account and log in to use the Service through
        the following Third-party Social Media Services: Google Facebook Twitter
        ...
        browser. Learn more about cookies: Cookies: What Do They Do?. We use
        ...
        us: By email: admin@nftoast.com.com
      </p>
    </div>
  )
}
